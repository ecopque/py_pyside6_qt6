...
from PySide6.QtWidgets import (QApplication, QPushButton, #2:
            QWidget, QVBoxLayout, QHBoxLayout, QGridLayout, #8: #10: #16: #17:
            QMainWindow) #19:

app = QApplication(sys.argv) #3:
window = QMainWindow() #20:
central_widget = QWidget() #9:
window.setCentralWidget(central_widget) #22:
window.setWindowTitle('Edson Copque Program') #32:
...
button.clicked.connect(slot3_example(sub_mark)) #39:
